"""
Neural Network implementation with curve merging capabilities for continual learning.
This module implements a multi-layer perceptron with curve-based model merging
