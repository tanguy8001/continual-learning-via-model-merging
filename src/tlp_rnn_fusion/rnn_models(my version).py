...
class RNNWithEncoderDecoder(nn.Module):
    ...
    ReLU activations as non-linearlity.
    """
    def __init__(self, output_dim, input_dim, embed_dim, hidden_dims, hidden_activations,bias=False,tie_weights=False):
        """
        :param input_dim: The input dimension
        :param hidden_dims: List of hidden dimensions for this model
        :param output_dim: Output dimension
...
class LSTMWithEncoderDecoder(nn.Module):
    ...
    def get_layer_weights(self, layer_num=1):
        ...
        if layer_num == 1:
            ...
            return (layer._parameters['weight_ih_l0'], layer._parameters['weight_hh_l0'])
            ...
            # return layer._parameters['weight_ih_l0'].reshape(4,hid_dim,input_dim),layer._parameters['weight_hh_l0'].reshape(4,hid_dim,hid_dim) # returen 4 concatenated weights
