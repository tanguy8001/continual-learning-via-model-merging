...
def main():
    ...
    if exp_args.model_name == "rnn":
        ...
        model = RNNWithEncoderDecoder(vocab_size = exp_args.vocab_size, embed_dim=exp_args.embed_dim,hidden_dims=hidden_dims, hidden_activations=hidden_activations,bias= exp_args.bias)
